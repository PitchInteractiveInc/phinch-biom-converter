...
htmlend = """
	...
	<div class="about">
		...
		<p class="description">Alternatively, you can use <a href="http://phinchconversion.pitchinteractive.com/">this web-based tool</a> to convert an HDF5-formatted <a href="http://biom-format.org/">BIOM</a> file to a JSON-formatted <a href="http://biom-format.org/">BIOM</a> file that will work with <a href="http://phinch.org/">Phinch</a>.</p>
		<a href="http://phinch.org/" target="_blank">
